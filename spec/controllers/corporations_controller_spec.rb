...
describe CorporationsController do
  ...
  describe "GET index" do
    it "assigns all corporations as @corporations" do
      ...
      assigns(:corporations).should eq([corporation])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested corporation as @corporation" do
      ...
      assigns(:corporation).should eq(corporation)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new corporation as @corporation" do
      ...
      assigns(:corporation).should be_a_new(Corporation)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created corporation as @corporation" do
        post :create, {:corporation => valid_attributes}, valid_session
        assigns(:corporation).should be_a(Corporation)
        assigns(:corporation).should be_persisted
      end

      it "redirects to the created corporation" do
        post :create, {:corporation => valid_attributes}, valid_session
        response.should redirect_to(Corporation.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved corporation as @corporation" do
        ...
        Corporation.any_instance.stub(:save).and_return(false)
        post :create, {:corporation => { "nombre" => "invalid value" }}, valid_session
        assigns(:corporation).should be_a_new(Corporation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested corporation" do
        corporation = Corporation.create! valid_attributes
        # Assuming there are no other corporations in the database, this
        # specifies that the Corporation created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Corporation.any_instance.should_receive(:update).with({ "nombre" => "MyString" })
        put :update, {:id => corporation.to_param, :corporation => { "nombre" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the corporation" do
        corporation = Corporation.create! valid_attributes
        put :update, {:id => corporation.to_param, :corporation => valid_attributes}, valid_session
        response.should redirect_to(corporation)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the corporation as @corporation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Corporation.any_instance.stub(:save).and_return(false)
        put :update, {:id => corporation.to_param, :corporation => { "nombre" => "invalid value" }}, valid_session
        assigns(:corporation).should eq(corporation)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the corporations list" do
      corporation = Corporation.create! valid_attributes
      delete :destroy, {:id => corporation.to_param}, valid_session
      response.should redirect_to(corporations_url)
    end
  end
